...
<?php
$sql="SELECT * FROM comp where id='$_GET[id]'" ;
...
<form method="post" action="detail.php">
	<table >
       ...
       <tr> <td>Name:</td> <td><?php echo "$nog"; ?></td></tr>
       <tr> <td>RollNO:</td> <td><?php echo "$rno"; ?></td></tr>
       <tr> <td>Categories of grivance:</td> <td><?php echo "$cat"; ?></td></tr>
       <tr> <td>Type of complaint:</td><td><?php echo "$type"; ?></td></tr>
       <tr> <td>Date of complaint:</td><td><?php echo "$date"; ?></td></tr>
       <tr> <td>Department:</td><td><?php echo "$depart"; ?></td></tr>
       <tr> <td>Description:</td><td><?php echo "$subject"; ?></td></tr>
       <tr> <td>File Uploads:</td><td><?php echo "$file"; ?></td></tr>
...
<?php
	...
	$qry="UPDATE `comp` SET `act`='".$act."' WHERE `id`=$id";
